 ...
 * Date: 2026-04-29
 * Description: Planning feedback text resolver for server-backed move path previews.
 *************************************************/
...
{
    /// <summary>
    /// Converts authoritative move preview DTO feedback into user-facing presentation text.
    /// </summary>
