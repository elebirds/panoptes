...
func writeConfigFixture(t *testing.T, repoRoot string) {
	...
	files := map[string]string{
		...
		"data/content/units/units.json": `{"units":[]}`,
		"data/content/buildings/buildings.json": `{"buildings":[]}`,
		...
		"data/content/ministers/ministers.json": `{"pool":[]}`,
		"data/content/maps/default/definition.json": `{"meta":{"id":"default","name":"默认地图","width":1,"height":1,"default_terrain":"plain"},"terrain_patches":[],"node_overrides":[],"features":{"resource_points":[],"roads":[],"named_nodes":[],"central_points":[]},"spawn_points":[]}`,
		...
		"data/ui/catalogs/units.json": `{"units":[]}`,
		"data/ui/catalogs/buildings.json": `{"buildings":[]}`,
