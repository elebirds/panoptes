...
func TestGenerateProducesSchemasBundlesAndGeneratedSources(t *testing.T) {
	...
	assertFileContains(t, filepath.Join(protocolDir, "data_types.proto"), "message ResourceBag")
	assertFileContains(t, filepath.Join(protocolDir, "data_types.proto"), "message PointBag")
	assertFileContains(t, filepath.Join(protocolDir, "data_types.proto"), "message PointDescriptor")
	assertFileContains(t, filepath.Join(protocolDir, "data_types.proto"), "message CatalogSectionHash")
	assertFileContains(t, filepath.Join(protocolDir, "data_catalog.proto"), "message MsgStaticCatalogManifest")
	assertFileContains(t, filepath.Join(protocolDir, "data_catalog.proto"), "message MsgStaticCatalogSyncRequest")
	...
	assertFileNotContains(t, filepath.Join(protocolDir, "data_catalog.proto"), "tech_point_cost")
}
