...
func TestResolutionEventKinds(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "city core damaged", kind: "city_core_damaged", ev: CastleDamagedEvent{}},
		{name: "city core destroyed", kind: "city_core_destroyed", ev: CastleDestroyedEvent{}},
...
func TestEconomyEventKinds(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "industry output refreshed", kind: "industry_output_refreshed", ev: BuildPointsRechargedEvent{}},
