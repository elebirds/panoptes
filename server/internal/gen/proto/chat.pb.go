...
func (x *ChatPayload) GetEmoteId() string {
	if x != nil {
		if x, ok := x.Body.(*ChatPayload_EmoteId); ok {
			return x.EmoteId
		}
	}
	return ""
...
type ChatPayload_EmoteId struct {
	EmoteId string `protobuf:"bytes,3,opt,name=emote_id,json=emoteId,proto3,oneof"`
}
...
func (*ChatPayload_EmoteId) isChatPayload_Body() {}
...
const file_panoptes_proto_v1_chat_proto_rawDesc = "" +
	"\n" +
	"\x1cpanoptes/proto/v1/chat.proto\x12\x11panoptes.proto.v1\"~\n" +
	"\vChatPayload\x124\n" +
	"\x05emote\x18\x01 \x01(\x0e2\x1c.panoptes.proto.v1.ChatEmoteH\x00R\x05emote\x12\x14\n" +
	"\x04text\x18\x02 \x01(\tH\x00R\x04text\x12\x1b\n" +
	"\bemote_id\x18\x03 \x01(\tH\x00R\aemoteIdB\x06\n" +
	"\x04body\"K\n" +
