...
type PolicyCatalogEntry struct {
	...
	BenefitDescription    string                 `protobuf:"bytes,8,opt,name=benefit_description,json=benefitDescription,proto3" json:"benefit_description,omitempty"`
	NextActionDescription string                 `protobuf:"bytes,9,opt,name=next_action_description,json=nextActionDescription,proto3" json:"next_action_description,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *PolicyCatalogEntry) GetBenefitDescription() string {
	if x != nil {
...
func (x *PolicyCatalogEntry) GetNextActionDescription() string {
	if x != nil {
		return x.NextActionDescription
	}
	return ""
}
...
const file_panoptes_proto_v1_data_catalog_proto_rawDesc = "" +
	...
	"\x04tags\x18\b \x03(\tR\x04tags\"\xb5\x02\n" +
	...
	"\x13benefit_description\x18\b \x01(\tR\x12benefitDescription\x126\n" +
	"\x17next_action_description\x18\t \x01(\tR\x15nextActionDescription\"\xf0\x01\n" +
