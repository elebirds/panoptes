...
const file_data_types_proto_rawDesc = "" +
	...
	"\vResourceBag\x126\n" +
	"\x05items\x18\x01 \x03(\v2 .panoptes.proto.v1.ResourceValueR\x05items\"\xee\x01\n" +
	...
	"\x0evisible_in_hud\x18\a \x01(\bR\fvisibleInHud\"\xd5\x01\n" +
...
var file_data_types_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_data_types_proto_goTypes = []any{
	...
	(*ResourceDescriptor)(nil),    // 2: panoptes.proto.v1.ResourceDescriptor
	(*StaticCatalogManifest)(nil), // 3: panoptes.proto.v1.StaticCatalogManifest
}
