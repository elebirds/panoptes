...
const file_game_state_proto_rawDesc = "" +
	"\n" +
	"\x10game_state.proto\x12\x11panoptes.proto.v1\x1a\fcommon.proto\x1a\x10data_types.proto\"\xe3\x03\n" +
	"\bNodeView\x12\x0e\n" +
	...
	"\twar_zones\x18\b \x03(\v2\x1a.panoptes.proto.v1.WarZoneR\bwarZones\"\x87\x01\n" +
	"\aWarZone\x12\x0e\n" +
...
var file_game_state_proto_goTypes = []any{
	...
	(*WarZone)(nil),      // 3: panoptes.proto.v1.WarZone
	(*MinisterView)(nil), // 4: panoptes.proto.v1.MinisterView
...
var file_game_state_proto_depIdxs = []int32{
	...
	2, // 6: panoptes.proto.v1.MsgGameInit.my_player:type_name -> panoptes.proto.v1.PlayerView
	4, // 7: panoptes.proto.v1.MsgGameInit.ministers:type_name -> panoptes.proto.v1.MinisterView
