...
func WrapServerMessage(msg proto.Message, meta *pb.EventMeta) (*pb.ServerFrame, error) {
	...
	case *pb.MsgStaticCatalogSectionChunk:
		frame.Target = &pb.ServerFrame_Game{Game: &pb.GameEvent{Body: &pb.GameEvent_StaticCatalogSectionChunk{StaticCatalogSectionChunk: typed}}}
	case *pb.MsgStaticCatalogSyncComplete:
	...
	case *pb.MsgBuildStructurePreviewResponse:
		frame.Target = &pb.ServerFrame_Game{Game: &pb.GameEvent{Body: &pb.GameEvent_BuildStructurePreviewResponse{BuildStructurePreviewResponse: typed}}}
	case *pb.MsgSetBuildingRecipePreviewResponse:
